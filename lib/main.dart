...
class _MyAppState extends State<MyApp> {
  ...
  ThemeData _buildAppTheme(BuildContext context) {
    ...
    return base.copyWith(
        primaryColor: Color(0xff484648),//primary
        accentColor: accent,
        scaffoldBackgroundColor:primary,// primary
  ...
  TextTheme _appTextTheme(BuildContext context, TextTheme base) {
    bool _isDarkMode = context.watch<ColorProvider>().darkMode;//darkMode
